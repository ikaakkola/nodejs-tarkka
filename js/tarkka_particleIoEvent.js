 ...
 * Usage:
 * 
 * nodejs tarkka_particleIoEvent.js apikey eventName /path/to/tarkka_query.js /tmp/tarkka_data.json highest 5 [ttl]
 * 
 * 
...
// Usage information
var usage = function() {
    console.log( "Usage: nodejs tarkka_particleIo.js apikey eventname queryJs file mode ttl" );
